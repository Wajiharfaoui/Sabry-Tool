...
def main():
    ...
    with tab1:
        ...
        year = col2.selectbox("Select Year", list(range(2024, 2025)), index=0, key="year_select")  # Default is 2020
    ...
    with tab2:
        ...
        year = col2.selectbox("Select Year", list(range(2024, 2025)), index=0, key="sea_year_select")
